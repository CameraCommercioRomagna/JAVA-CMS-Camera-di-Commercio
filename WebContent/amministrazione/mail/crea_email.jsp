...
<div style="clear:both;overflow:hidden;max-width:600px;display:block;font-family :sans-serif, Helvetica, Arial; margin-left:10px; font-size: 16px;">
	<!--div style="background-image: url('http://www.xxx.it/imgs/header_mail.png');">
		<a href="http://www.xxx.it" title="XXX">
			<img src="http://www.xxx.it/imgs/struct/romagna-marchio-bianco.png" style="width:50%; float:left; margin:5px 10px; " alt="XXX" border="0"/></a>
