(function (factory) {
    ...
    function DateTimePicker(element, options) {
        var picker = {},
			...
			/*I18N =CONSTS.I18N['it'],*/ /*Da eliminare fatto da Chiara*/
            cache = {
                showYear: null,
                showMonth: null
            },
            ...
            _createButtonPane = function () {
                ...
                var $row = $('<tr/>');
                // clear button
				// Tolti i bottono in fondo modifica xchè non servono Chiara
            ...
            /** Tolta la navigazione negli anni
             * go to prev 10 years
             * @private
             */
           _toPrevDecade = function () {
            ...
            _loadDateData = function (table, date) {
                ...
                var std = options.startDate,
                 edd = options.endDate;
					/********************** Modificata opzione di end Date Chiara *********************************/
					//d = new Date();
					//edd=d.setDate(d.getDate() + 30);
					/**********/
                //set title
                ...
                for (var i = 0; i < 6; i++) {
                    ...
                    for (var j = 0; j < 7; ++j, date.setDate(iday + 1)) {
                        ...
                        if (!current_month || $cell.text(iday)>currentDate) {
                            $cell.addClass('oday').data('disabled', true);
                            continue;
                        }
                        var disabled = false;
                        if ((std != null && std > date) || (edd != null && edd < date +30)) {
                            //out of date range
                        ...
                        if (!disabled) {
                            ...
                            if (wday === 0 || wday === 6) {
								...
								/***************************** Disabilitati i week end by Chiara ********************************/
								$cell.addClass('oday').data('disabled', true);
                            }
